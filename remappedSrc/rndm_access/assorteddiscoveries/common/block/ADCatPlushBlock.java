...
public class ADCatPlushBlock extends ADAbstractPlushBlock {
    ...
    static {
        ...
        NORTH_RIGHT_EYE = Block.createCuboidShape(8.5D, 6.0D, 0.5D, 10.5D, 8.0D, 1.0D);
        NORTH_LEFT_EYE = Block.createCuboidShape(5.5D, 6.0D, 0.5D, 7.5D, 8.0D, 1.0D);
        NORTH_HEAD = Block.createCuboidShape(4.5D, 3.0D, 1.0D, 11.5D, 9.5D, 8.0D);
        NORTH_RIGHT_EAR = Block.createCuboidShape(5.0D, 9.5D, 3.5D, 7.0D, 11.0D, 6.5D);
        NORTH_LEFT_EAR = Block.createCuboidShape(9.0D, 9.5D, 3.5D, 11.0D, 11.0D, 6.5D);
        NORTH_FRONT_RIGHT_LEG = Block.createCuboidShape(5.0D, 0.0D, 4.0D, 7.0D, 2.0D, 6.0D);
        NORTH_FRONT_LEFT_LEG = Block.createCuboidShape(9.0D, 0.0D, 4.0D, 11.0D, 2.0D, 6.0D);
        NORTH_BACK_RIGHT_LEG = Block.createCuboidShape(5.0D, 0.0D, 10.0D, 7.0D, 2.0D, 12.0D);
        NORTH_BACK_LEFT_LEG = Block.createCuboidShape(9.0D, 0.0D, 10.0D, 11.0D, 2.0D, 12.0D);
        NORTH_TORSO = Block.createCuboidShape(5.0D, 2.0D, 4.0D, 11.0D, 7.0D, 12.0D);
        ...
        NORTH_BODY = VoxelShapes.union(NORTH_TORSO, NORTH_HEAD, NORTH_LEGS,
