...
public class ADCaveSpiderPlushBlock extends ADPlushBlock {
    protected static final VoxelShape NORTH_SHAPE = Block.box(1.0D, 0.0D, 1.0D, 15.0D, 6.0D, 15.0D);
    ...
    public ADCaveSpiderPlushBlock(Settings properties) {
        super(properties);
    }
