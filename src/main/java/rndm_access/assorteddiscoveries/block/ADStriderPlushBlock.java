...
public class ADStriderPlushBlock extends ADPlushBlock {

    public static final VoxelShape NORTH_SHAPE = Block.box(1.0, 0.0, 2.0, 15.0, 16.0, 14.0);
    ...
    public ADStriderPlushBlock(Properties properties) {
        super(properties);
    }
