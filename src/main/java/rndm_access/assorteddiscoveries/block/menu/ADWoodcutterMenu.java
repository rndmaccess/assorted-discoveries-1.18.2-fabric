package rndm_access.assorteddiscoveries.block.menu;
...
public class ADWoodcutterMenu extends AbstractContainerMenu {
    ...
    public final Container inputInventory = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            ADWoodcutterMenu.this.slotsChanged(this);
            ADWoodcutterMenu.this.slotUpdateListener.run();
        }
    };

    private final ResultContainer resultContainer = new ResultContainer();

    public ADWoodcutterMenu(int windowIdIn, Inventory playerInventoryIn) {
        this(windowIdIn, playerInventoryIn, ContainerLevelAccess.NULL);
    }

    public ADWoodcutterMenu(int windowIdIn, Inventory inventoryIn, final ContainerLevelAccess accessIn) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            public void onTake(Player player, ItemStack stack) {
                ...
                ADWoodcutterMenu.this.resultContainer.awardUsedRecipes(player);
                ItemStack itemstack = ADWoodcutterMenu.this.inputSlot.remove(1);
                Random random = player.getRandom();

                if (!itemstack.isEmpty()) {
                    ADWoodcutterMenu.this.setupResultSlot();
                }

                accessIn.execute((level, pos) -> {
                    long l = level.getGameTime();
                    if (ADWoodcutterMenu.this.lastSoundTime != l) {
                        ...
                        ADWoodcutterMenu.this.lastSoundTime = l;
                    }
                });
