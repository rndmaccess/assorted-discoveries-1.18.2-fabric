...
public class ADWitchsCradleSporeParticle extends SpriteBillboardParticle {

    protected ADWitchsCradleSporeParticle(ClientWorld clientWorld, double x, double y, double z, double xd, double yd, double zd) {
    ...
    public record Factory(SpriteProvider sprite) implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld,
            ...
            ADWitchsCradleSporeParticle particle = new ADWitchsCradleSporeParticle(clientWorld, x, y, z, xd, yd, zd);
