...
public class ADChickenPlushBlock extends ADDirectionalPlushBlock {
    private static final VoxelShape NORTH_FEET_SHAPE;
    private static final VoxelShape NORTH_TORSO_SHAPE;
    private static final VoxelShape NORTH_WINGS_SHAPE;
    ...
    private static final VoxelShape NORTH_LEFT_LEG_BACK_SHAPE;
    private static final VoxelShape NORTH_RIGHT_LEG_BACK_SHAPE;
    private static final VoxelShape NORTH_LEFT_LEG_FRONT_SHAPE;
    private static final VoxelShape NORTH_RIGHT_LEG_FRONT_SHAPE;

    private static final VoxelShape NORTH_LEGS_SHAPE;
