...
public class ADSavannaZombieVillagerPlushBlock extends ADSavannaVillagerPlushBlock {
    protected static final VoxelShape NORTH_BODY = Shapes.or(NORTH_HEAD, NORTH_TORSO, NORTH_ZOMBIE_VILLAGER_ARMS);
    protected static final VoxelShape NORTH_SHAPE = Shapes.or(NORTH_FEET, NORTH_FACE, NORTH_BODY, NORTH_HEADBAND);
    ...
    public ADSavannaZombieVillagerPlushBlock(Properties properties) {
        super(properties);
    }
