...
public class ADZombieDemonPlushBlock extends ADZombiePlushBlock {
    ...
    protected static final VoxelShape SOUTH_SHAPE = ADShapeUtil.rotate180Y(NORTH_SHAPE);
    protected static final VoxelShape WEST_SHAPE = ADShapeUtil.rotate270Y(NORTH_SHAPE);
    protected static final VoxelShape EAST_SHAPE = ADShapeUtil.rotate90Y(NORTH_SHAPE);
