...
public class ADParticleTypes {
    ...
    private static DefaultParticleType register(String id) {
        ...
        return Registry.register(Registry.PARTICLE_TYPE, new Identifier(AssortedDiscoveries.MOD_ID, id), particle);
    }
    ...
    public static void registerParticles() {
        AssortedDiscoveries.LOGGER.info("Registering particles");
    }
